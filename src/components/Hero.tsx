  ...
  return <section className="min-h-screen flex items-center relative overflow-hidden pt-16">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          {/* Avatar */}
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end animate-fade-up" style={{
          animationDelay: "0.3s"
        }}>
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-primary/30 shadow-[0_0_40px_hsl(var(--neon-green)/0.3)]">
                <img src={avatarImage} alt={`${firstName} ${lastName}`} className="w-full h-full object-cover shadow-none" loading="eager" />
              </div>
            </div>
          </div>
        </div>
